          ...
          <nav className="space-y-2">
            {navItems.map((item) => (
              <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg text-left transition-all duration-200 ${activeItem === item.id
              ...
              >
                ...
                {!isCollapsed && (
                  <>
                    ...
                    {item.badge && (
                      <span
                        className={`px-2 py-0.5 text-xs rounded-full ${item.badge === "New"
